...
public class PopupwindowUtils {
    ...
    private volatile static PopupwindowUtils mInstance;
...
//        }
     ...
     * 显示菜单
     */
    public <T> void showMenu(Context context, View target, List<T> datas, final OnPopupWindowListener<T> listener) {
...
//                FrameLayout.LayoutParams.WRAP_CONTENT, true);
        popupWindow = new PopupWindow(view, width, FrameLayout.LayoutParams.WRAP_CONTENT, true);

        LinearLayout rlParent = view.findViewById(R.id.llParent);
        ...
        recyclerView.setAdapter(new CommonAdapter<T>(context, R.layout.popupwindow_menu_item,
                datas) {
            @Override
